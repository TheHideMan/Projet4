    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <h2>Section commentaire</h2>
                ...
                <p class="border rounded">
                    ...
                    <a href="index.php?action=delComms&id=<?php echo $donnes['id_post'] ?>">Supprimer le commentaire </a>
                </p>
            ...
            <div class="col-sm-12 col-lg-6">
                ...
                <p class="border rounded" style="background-color:red">
                    ...
                    <a href="index.php?action=delComms&id=<?php echo $data['id_post'] ?>">Supprimer le commentaire </a>
                </p>
        ...
        <div class="row">
            <div class="col-6 text-center">
                <a href="index.php?action=writeChapter" class="adminButton" > Rédiger un chapitre </a>
            </div>
            <div class="col-6 text-center">
                <a href="index.php?action=writeArticle" class="adminButton" > Rédiger un article </a>
            </div>
        </div>
